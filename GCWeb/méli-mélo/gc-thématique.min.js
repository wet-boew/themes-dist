...
async function aiAnswersAvailabilityCheck(){let a=document.querySelectorAll(".aia-banner, .aia-rescue");var e=()=>a.forEach(a=>a.remove());try{var s,n=await fetch("https://ai-answers.alpha.canada.ca/api/chat/chat-session-availability");n?.ok?(s=await n.json())?.siteStatus&&s?.sessionAvailable||e():e()}catch{e()}}(()=>{if(document.querySelector(".ai-answers-trigger")){var e=document.documentElement.lang,s=document.querySelector("header"),a=document.querySelector(".pagedetails > h2"),n="true"===sessionStorage.getItem("aiaClosed"),t={main:{fr:`
				...
				</section>`}};if(a.insertAdjacentHTML("afterend",t.rescue[e]),!n){s.insertAdjacentHTML("beforebegin",t.main[e]);let a=document.querySelector(".aia-close");a.addEventListener("click",()=>{a.parentElement.remove(),sessionStorage.setItem("aiaClosed","true")})}aiAnswersAvailabilityCheck()}})(),((s,n)=>{var t,a=n.doc,i="gc-empathy",r=".provisional."+i;a.on("timerpoke.wb wb-init .provisional.gc-empathy",r,function(a){var e=n.init(a,i,r);e&&a.currentTarget===a.target&&(a=s(e),(t=s(".quiz-content"))&&(t.clone().addClass("hidden-md hidden-lg").insertBefore(" .services-and-information "),t.addClass("hidden-xs hidden-sm")),e.classList.add("no-blink"),n.ready(a,i))}),n.add(r)})(jQuery,(window,wb));