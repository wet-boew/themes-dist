...
<title>[Titre du sujet] - Canada.ca
</title>
...
<link rel="alternate" hreflang="en" href="topic-en.html">
...
<li>
<a lang="en" hreflang="en" href="topic-en.html">
...
<div class="container">
<ol class="breadcrumb">
<li><a href="https://www.canada.ca/fr.html">Canada.ca</a></li><li><a href="theme-fr.html">[Thème]</a></li>
</ol>
</div>
</nav>
</header>
...
<div class="col-md-6">
<h1 property="name" id="wb-cont">[Titre du sujet]</h1>
...
<li><a href="#" rel="external">[Titre du premier compte Facebook]</a></li>
<li><a href="#" rel="external">[Titre du deuxième compte Facebook]</a></li>
</ul>
</div>
</section>
...
<div class="modal-body">
<ul class="list-unstyled lst-spcd">
<li><a href="#" rel="external">[Titre du premier compte YouTube]</a></li>
<li><a href="#" rel="external">[Titre du deuxième compte YouTube]</a></li>
<li><a href="#" rel="external">[Titre du troisième compte YouTube]</a></li>
</ul>
</div>
</section>
</div>
...
<ul>
<li><a href="#">[Lien à une tâche principale]
</a></li>
<li><a href="#">[Lien à une tâche principale]
</a></li>
<li><a href="#">[Lien à une tâche principale]
...
<ul>
<li><a href="#">[Nom de l’institution]</a></li>
<li><a href="#">[Nom de l’institution]</a></li>
<li><a href="#">[Nom de l’institution]</a></li>
</ul>
</section>
...
<ul>
<li><a href="#">[Lien à un sujet pour un auditoire ciblé]</a></li>
<li><a href="#">[Lien à un sujet pour un auditoire ciblé]</a></li>
<li><a href="#">[Lien à un sujet pour un auditoire ciblé]</a></li>
</ul>
</section>
...
<h3>La recherche</h3>
<ul>
<li><a href="#">[Notre étude 1]</a></li>
<li><a href="#">[Notre étude 2 avec un long titre]</a></li>
<li><a href="#">[Notre étude 3 avec un long titre]</a></li>
<li><a href="#">[La recherche 4]</a></li>
</ul>
<p><a href="#">Tous les rapports d’étude connexes</a></p>
</section>
<section class="col-lg-4 col-md-6">
<h3>Enquêtes</h3>
<ul>
<li><a href="#">[Enquête 1]</a></li>
<li><a href="#">[Enquête 2 avec un long titre]</a></li>
<li><a href="#">[Enquête 3]</a></li>
<li><a href="#">[Enquête 4]</a></li>
</ul>
<p><a href="#">Toutes les enquêtes connexes</a></p>
</section>
<section class="col-lg-4 col-md-6">
<h3>Consultations</h3>
<ul>
<li><a href="#">[Consultation 1]</a></li>
<li><a href="#">[Consultation 2 avec un long titre]</a></li>
<li><a href="#">[Consultation 3]</a></li>
<li><a href="#">[Consultation 4 avec un long titre]</a></li>
</ul>
<p><a href="#">Toutes les consultations connexes</a></p>
</section>
</div>
</section>
...
<a href="#">
<figure>
<figcaption>[Lien à l’élément en vedette]</figcaption>
